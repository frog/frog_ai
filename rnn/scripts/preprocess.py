...
parser.add_argument('--input_txt', default='data/input.txt')
parser.add_argument('--output_h5', default='data/input.h5')
parser.add_argument('--output_json', default='data/input.json')
